...
(function (global) {
  ...
  /* 两种风格并存：
     一、多色斑派（花影 / 晚霞）—— 像一张糊掉的照片，色彩层次丰富；
     二、干净渐变派（青柠 / 潮汐 / 拂晓 / 绯夜）—— 照用户挑的参考图还原，
         纵向两三色过渡，没有杂色斑。这一派的色值直接取自参考图标注
         （#2DFFF5→#FFF878、#0172AF→#74FEBD 等）。
     每款都要能"当得起背景"：不脏、不灰、不用低明度暖色（那会变成褐色）。 */
  const PRESETS = [
    P('none', '无', ''),
    P('bloom', '花影',
    ...
    P('dusk', '晚霞',
      'radial-gradient(58% 44% at 22% 86%, rgba(255, 176, 92, .62), rgba(255, 176, 92, 0) 62%),' +
      'radial-gradient(50% 38% at 76% 74%, rgba(238, 122, 112, .46), rgba(238, 122, 112, 0) 62%),' +
      'radial-gradient(54% 42% at 82% 12%, rgba(134, 92, 220, .48), rgba(134, 92, 220, 0) 64%),' +
      'radial-gradient(42% 32% at 10% 18%, rgba(255, 220, 176, .32), rgba(255, 220, 176, 0) 58%),' +
      'linear-gradient(188deg, #2d1c52 0%, #74306e 42%, #e0634d 100%)'),
    P('mint', '青柠',
      'linear-gradient(178deg, #2df0e8 0%, #6ef0c4 32%, #b8f49a 64%, #e8f87e 86%, #fff878 100%)'),
    P('tide', '潮汐',
      'linear-gradient(180deg, #0172af 0%, #168fbe 30%, #35bfb4 62%, #58e6ba 84%, #74febd 100%)'),
    P('dawn', '拂晓',
      'linear-gradient(180deg, #121f57 0%, #1c3a9e 24%, #2f6ad0 50%, #8fc0ee 78%, #f0f6ff 100%)'),
    P('crimson', '绯夜',
      'radial-gradient(118% 78% at 10% 6%, rgba(255, 62, 104, .90), rgba(255, 62, 104, 0) 64%),' +
      'linear-gradient(150deg, #d81f46 0%, #93172f 30%, #3a0d14 64%, #0c0507 100%)'),
  ];
